...
var lastWeek = getDateStr(getLastWeek());
            ...
            __left.forEach(function(v, i){
                ...
                v.subClass.forEach(function(w, j){
                    Schema.aggregate([{$match:{'@type':w.docs.toObject()['@id']}},
                        ...
                        f_idx++;
                        if(f_idx === curr_idx - 1) {
                            _commObj['structure_data'] = structure_data;
                            _commObj['searchList'] = searchList;
                            _commObj['nowDate'] = nowDate;
                            _commObj['lastWeek'] = lastWeek;
                            _commObj['__left'] = __left;
                            _commObj['__facet_list'] = __facet_list;
                            _commObj['subProductList'] = subProductList;
                            _commObj['facet_count_list'] = facet_count_list;
                            _commObj['collection'] = collection;
                            _commObj['inputType'] = inputType;
                            _commObj['register_list'] = register_list;
                            _commObj['subClass'] = subClass;
                            _commObj['middle_list'] = middle_list;
                            cb();
                        }
                    });
                });
...
function cb(){
    require('./router/main')($app, fs, Schema, _commObj);
    require('./router/admin')($app, fs, Schema, _commObj);
}
